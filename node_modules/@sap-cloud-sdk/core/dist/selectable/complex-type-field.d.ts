...
export declare type ConstructorOrField<EntityT extends Entity> = Constructable<EntityT> | ComplexTypeField<EntityT>;
/**
 ...
 */
export declare function getEntityConstructor<EntityT extends Entity>(arg: Constructable<EntityT> | ComplexTypeField<EntityT>): Constructable<EntityT>;
/**
 ...
 * @returns EdmType
 */
export declare function getEdmType(arg1: string | EdmType, arg2: EdmType | undefined): EdmType;
