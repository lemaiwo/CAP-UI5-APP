...
class FullQualifiedName {
    ...
    static createFromNameSpaceAndName(namespaceAndName) {
        validateThat('namespaceAndName', namespaceAndName).truthy().typeOf('string');
        ...
        return new FullQualifiedName(
            namespaceAndName.substring(0, dotIdx),
            namespaceAndName.substring(dotIdx + 1));
    }
    ...
    static equals(fullQualifiedName1, fullQualifiedName2) {
        ...
        return fullQualifiedName1.namespace === fullQualifiedName2.namespace
