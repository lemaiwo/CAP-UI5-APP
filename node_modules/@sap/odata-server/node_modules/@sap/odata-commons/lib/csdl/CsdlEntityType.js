...
class CsdlEntityType {
     ...
     */
    setKey(key) {
        validateThat('key', key).notNullNorUndefined().array().containsInstancesOf(Object);
    ...
    setBaseType(baseType) {
        validateThat('baseType', baseType).truthy().instanceOf(Object);
    ...
    setHasStream(hasStream) {
        validateThat('hasStream', hasStream).notNullNorUndefined().typeOf('boolean');
