...
class CsdlJsonProvider extends CsdlProvider {
    ...
    getEntityContainerInfo(entityContainerName) {
        ...
        return value === null || value === undefined ?
            null :
            new CsdlEntityContainerInfo(entityContainerName);
    }
    ...
    _readFacets(obj, objJson, allowedFacets) {
        ...
        for (const facet of allowedFacets) {
            ...
            if (Object.prototype.hasOwnProperty.call(objJson, facet)) {
                ...
                switch (facet) {
                    case '$Nullable': obj.setNullable(value); break;
                    case '$MaxLength': obj.setMaxLength(value); break;
                    case '$Scale': obj.setScale(value); break;
                    case '$SRID': obj.setSrid(value); break;
                    case '$DefaultValue': obj.setDefaultValue(value); break;
                    case '$Collection': obj.setCollection(value); break;
                    default:
                }
            }
        }
